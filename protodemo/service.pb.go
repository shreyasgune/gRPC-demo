...
func init() {
	proto.RegisterType((*Request)(nil), "protodemo.Request")
	proto.RegisterType((*Response)(nil), "protodemo.Response")
}
...
var fileDescriptor_a0b84a42fa06f626 = []byte{
	...
	0xcb, 0x4c, 0x4e, 0xd5, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x04, 0x53, 0x29, 0xa9, 0xb9,
	0xf9, 0x4a, 0xaa, 0x5c, 0xec, 0x41, 0xa9, 0x85, 0xa5, 0xa9, 0xc5, 0x25, 0x42, 0x3c, 0x5c, 0x8c,
	...
	0x00, 0xff, 0xff, 0xfd, 0xd7, 0x3e, 0xad, 0xe0, 0x00, 0x00, 0x00,
}
...
func (c *addServiceClient) Add(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/protodemo.AddService/Add", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *addServiceClient) Multiply(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/protodemo.AddService/Multiply", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AddService_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protodemo.AddService/Add",
	}
...
func _AddService_Multiply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protodemo.AddService/Multiply",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _AddService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "protodemo.AddService",
